  ...
  while (isRunning) {
    ...
    case 1:
      ...
      for (const auto &i : db_list) {
        printf(FORMATTED_DB, i.brand, i.model, i.display_type, i.display_size,
               i.display_rate, i.wheight, i.cpu_name, i.core_count, i.ram_size,
               i.rom_size);
      }
      break;
    case 2:
    ...
    case 3:
      ...
      if (!found.empty())
        for (const auto &i : found)
          printf(FORMATTED_DB, i.brand, i.model, i.display_type, i.display_size,
                 i.display_rate, i.wheight, i.cpu_name, i.core_count,
                 i.ram_size, i.rom_size);
      else
